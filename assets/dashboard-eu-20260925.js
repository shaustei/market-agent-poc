(() => {
  const STAMP='2026-09-25T10:00:00+02:00', CUTOFF='2026-05-25';
  ...
  async function boot(){
    ...
    const hnr=window.holdings.find(h=>h.id==='HNR1');if(hnr){hnr.analystNote='Rollierendes Vier-Monats-Fenster ab 25.05.2026, geprüft bis 25.09.2026 10:00 CEST. Keine neue belastbar verifizierte Einzelrevision gegenüber dem vorherigen EU-Lauf; bestehende valide Einträge bleiben erhalten.';hnr.insiderNote='Rollierendes Vier-Monats-Fenster ab 25.05.2026 geprüft; keine neue relevante diskretionäre Open-Market-Transaktion verifiziert.';}
    ...
    const lha=window.holdings.find(h=>h.id==='LHA');if(lha){lha.analystNote='Rollierendes Vier-Monats-Fenster ab 25.05.2026, geprüft bis 25.09.2026 10:00 CEST. Keine neue belastbar verifizierte Einzelrevision gegenüber dem vorherigen EU-Lauf.';lha.insiderNote='Rollierendes Vier-Monats-Fenster ab 25.05.2026 geprüft; keine neue relevante diskretionäre Open-Market-Transaktion verifiziert.';}
    const alv=window.holdings.find(h=>h.id==='ALV');if(alv){alv.analystNote='Rollierendes Vier-Monats-Fenster ab 25.05.2026, geprüft bis 25.09.2026 10:00 CEST. Keine neue belastbar verifizierte Einzelrevision gegenüber dem vorherigen EU-Lauf; bestehende valide Einträge bleiben erhalten.';alv.insiderNote='Rollierendes Vier-Monats-Fenster ab 25.05.2026 geprüft; keine neue relevante diskretionäre Open-Market-Transaktion verifiziert.';}
    ...
    const f=document.querySelector('footer.shell');if(f)f.textContent='Market Agent · Datenstand 25.09.2026 · 10:00 · Quellen in jedem Eintrag';
  }
  boot();
})();