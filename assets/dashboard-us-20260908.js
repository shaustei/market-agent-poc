(() => {
  ...
  function applyRun() {
    ...
    if (rng) {
      ...
      addInsider(rng,{date:'2026-09-03',name:'Tarun Arora · Chief Accounting Officer',type:'Verkauf · Rule 10b5-1 / Steuerdeckung',shares:954,price:77,volume:73458,context:'SEC Form 4; vorab festgelegter Rule-10b5-1-Plan zur Deckung von Steuerabzug aus vestenden Aktienvergütungen. Kein diskretionärer Open-Market-Verkauf.',source:'https://www.marketbeat.com/instant-alerts/insider-ringcentral-nyse-rng-cao-sells-7345800-in-stock-2026-09-03/'});
      addInsider(rng,{date:'2026-09-02',name:'Vladimir Shmunis · CEO',type:'Verkauf · Rule 10b5-1 / Steuerdeckung',shares:15556,price:71.78,volume:1116609.68,context:'SEC Form 4; vorab festgelegter Rule-10b5-1-Plan zur Deckung von Steuerabzug aus vestenden Aktienvergütungen. Kein diskretionärer Open-Market-Verkauf.',source:'https://www.marketbeat.com/instant-alerts/insider-vladimir-shmunis-sells-15556-shares-of-ringcentral-nyse-rng-stock-2026-09-03/'});
      ...
      rng.insiderNote = 'SEC-/Insiderquellen im Vier-Monats-Fenster geprüft. Neu erfasst sind die publizierten Verkäufe von Vladimir Shmunis und Tarun Arora; beide erfolgten laut Filing unter Rule 10b5-1 zur Steuerdeckung vestender Equity Awards und werden daher nicht als diskretionäres Verkaufssignal interpretiert.';
